...
A desktop **School Management System** built using **Python, PyQt5, and SQLite**.  
It allows managing students, marks, fees, and attendance in a simple graphical interface.
...
- Record attendance (morning / evening)
